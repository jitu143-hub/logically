locals {
  ...
  gcp_onprem_shared_secret_t1 = local.project_vars.locals.gcp_onprem_shared_secret_t1
  gcp_onprem_shared_secret_t2 = local.project_vars.locals.gcp_onprem_shared_secret_t2
...
inputs = {
    ...
    gcp_onprem_shared_secret_t1 = local.gcp_onprem_shared_secret_t1
    gcp_onprem_shared_secret_t2 = local.gcp_onprem_shared_secret_t2
