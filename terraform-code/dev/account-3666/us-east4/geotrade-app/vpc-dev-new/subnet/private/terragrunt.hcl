locals {
  ...
  dev_app_central_subnet_private_ip = local.project_vars.locals.dev_app_central_subnet_private_ip
  dev_app_central_subnet_range_pod_ip = local.project_vars.locals.dev_app_central_subnet_range_pod_ip
  dev_app_central_subnet_range_service_ip = local.project_vars.locals.dev_app_central_subnet_range_service_ip
...
inputs = {
    ...
    dev_app_central_subnet_private_ip = local.dev_app_central_subnet_private_ip
    dev_app_central_subnet_range_pod_ip = local.dev_app_central_subnet_range_pod_ip
    dev_app_central_subnet_range_service_ip = local.dev_app_central_subnet_range_service_ip
