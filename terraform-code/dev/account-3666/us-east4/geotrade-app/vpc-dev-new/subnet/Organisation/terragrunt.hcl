locals {
  ...
  org_subnet_private_ip = local.project_vars.locals.org_subnet_private_ip
  org_subnet_range_pod_ip = local.project_vars.locals.org_subnet_range_pod_ip
  org_subnet_range_service_ip = local.project_vars.locals.org_subnet_range_service_ip
...
inputs = {
    ...
    org_subnet_private_ip = local.org_subnet_private_ip
    org_subnet_range_pod_ip = local.org_subnet_range_pod_ip
    org_subnet_range_service_ip = local.org_subnet_range_service_ip
