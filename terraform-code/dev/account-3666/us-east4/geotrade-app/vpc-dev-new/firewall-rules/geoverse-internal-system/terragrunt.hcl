locals {
  ...
  dev_geoverse_internal_master_ipv4_cidr_block = local.project_vars.locals.dev_geoverse_internal_master_ipv4_cidr_block
...
inputs = {
    ...
    dev_geoverse_internal_master_ipv4_cidr_block = local.dev_geoverse_internal_master_ipv4_cidr_block
}