...
resource "google_compute_router" "geotrade-app-nat-router-dev-new" {
  project = var.project_id
  name    = "geotrade-app-nat-router-dev-new"
...
module "geotrade-app-cloud-nat" {
  ...
  region                             = var.gcp_region
  router                             = google_compute_router.geotrade-app-nat-router-dev-new.name
  name                               = "geotrade-app-nat-config-dev-new"
