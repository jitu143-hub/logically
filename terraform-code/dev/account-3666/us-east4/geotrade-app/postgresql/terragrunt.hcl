locals {
  ...
  db_name = local.project_vars.locals.db_name
  db_instance_name = local.project_vars.locals.db_instance_name
  db_master_user_name = local.project_vars.locals.db_master_user_name
  db_master_user_password = local.project_vars.locals.db_master_user_password
  db_machine_type = local.project_vars.locals.db_machine_type
  db_postgres_version = local.project_vars.locals.db_postgres_version
...
inputs = {
    ...
    db_master_user_name = local.db_master_user_name
    db_master_user_password = local.db_master_user_password
    db_machine_type = local.db_machine_type
