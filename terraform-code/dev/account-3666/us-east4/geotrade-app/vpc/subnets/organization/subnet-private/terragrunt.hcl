locals {
  ...
  app_org_subnet_private_ip = local.project_vars.locals.app_org_subnet_private_ip
  app_org_subnet_range_pod_ip = local.project_vars.locals.app_org_subnet_range_pod_ip
  app_org_subnet_range_service_ip = local.project_vars.locals.app_org_subnet_range_service_ip
...
inputs = {
    ...
    app_org_subnet_private_ip = local.app_org_subnet_private_ip
    app_org_subnet_range_pod_ip = local.app_org_subnet_range_pod_ip
    app_org_subnet_range_service_ip = local.app_org_subnet_range_service_ip
}