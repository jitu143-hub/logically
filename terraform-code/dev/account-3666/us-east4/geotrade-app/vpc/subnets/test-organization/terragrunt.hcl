locals {
  ...
  test_org_subnet_private_ip = local.project_vars.locals.test_org_subnet_private_ip
  test_org_subnet_range_pod_ip = local.project_vars.locals.test_org_subnet_range_pod_ip
  test_org_subnet_range_service_ip = local.project_vars.locals.test_org_subnet_range_service_ip
...
inputs = {
    ...
    test_org_subnet_private_ip = local.test_org_subnet_private_ip
    test_org_subnet_range_pod_ip = local.test_org_subnet_range_pod_ip
    test_org_subnet_range_service_ip = local.test_org_subnet_range_service_ip
}