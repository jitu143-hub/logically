locals {
  ...
  geoverse_internal_subnet_private_ip = local.project_vars.locals.geoverse_internal_subnet_private_ip
  geoverse_internal_subnet_range_pod_ip = local.project_vars.locals.geoverse_internal_subnet_range_pod_ip
  geoverse_internal_subnet_range_service_ip = local.project_vars.locals.geoverse_internal_subnet_range_service_ip
...
inputs = {
    ...
    geoverse_internal_subnet_private_ip = local.geoverse_internal_subnet_private_ip
    geoverse_internal_subnet_range_pod_ip = local.geoverse_internal_subnet_range_pod_ip
    geoverse_internal_subnet_range_service_ip = local.geoverse_internal_subnet_range_service_ip
