locals {
  ...
  dev_app_central_subnet_networkname = local.project_vars.locals.dev_app_central_subnet_networkname
  ...
  dev_app_central_master_ipv4_cidr_block = local.project_vars.locals.dev_app_central_master_ipv4_cidr_block
...
inputs = {
    ...
    dev_app_central_master_ipv4_cidr_block = local.dev_app_central_master_ipv4_cidr_block
    dev_app_central_subnet_networkname = local.dev_app_central_subnet_networkname
}