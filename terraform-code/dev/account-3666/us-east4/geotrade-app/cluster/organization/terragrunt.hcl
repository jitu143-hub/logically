locals {
  ...
  app_org_master_ipv4_cidr_block = local.project_vars.locals.app_org_master_ipv4_cidr_block
...
inputs = {
    ...
    app_org_master_ipv4_cidr_block = local.app_org_master_ipv4_cidr_block
}